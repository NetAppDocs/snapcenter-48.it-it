...
+
Nella pagina Resources, l' image:../media/not_supported_icon.png["icona non supportata"] icona indica che il database si trova su sistemi di storage non NetApp.
...
NOTE: È anche possibile creare una policy facendo clic su * *image:../media/add_policy_from_resourcegroup.gif["aggiungere criteri dai gruppi di risorse"].
