...
* Se si dispone di database Oracle su ambienti SAN, accertarsi che l'ambiente SAN sia configurato come indicato nella https://library.netapp.com/ecm/ecm_download_file/ECMP1119218["Impostazioni host interessate dalle utility host AIX"^] guida.
